...
Instance_Public_Ip=$(aws ec2 describe-instances --instance-ids "i-04d0291415xxxxxx" | grep -i publicIpAddress | awk -F ":" '{print $2}')
...
then
        ...
        #Example: aws sns publish --topic-arn arn:aws:sns:us-east-1:654654325967:EC2_CPU_UTIL_NOTIFICATION --message 
